(function ($) {
    ...
    $(function () {
        ...
        $('.get-in-touch-input-row, .popup-input-row').each(function(){
            var $_this = (this)
            $('.get-in-touch-input-row, .popup-input-row').find('input, textarea').on('keyup', function() {       
                var $$_this = $(this)
                
            if ($$_this.val() == '') {
                $$_this.parent('.get-in-touch-input-row, .popup-input-row').removeClass('add_border');
            } else {
                $$_this.parent('.get-in-touch-input-row, .popup-input-row').addClass('add_border');
            }
        });
